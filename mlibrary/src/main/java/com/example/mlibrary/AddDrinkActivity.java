...
public class AddDrinkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayadapter = new ArrayAdapter<String>(AddDrinkActivity.this,R.layout.textviewl,stringlist );
    ...
    private void setWindowFlag(AppCompatActivity mainActivity, final int bits, boolean b) {
